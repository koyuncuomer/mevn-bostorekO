<template>
    ...
    <div class="row mb-3">
        <div class="col text-end">
            <button @click="modal.show()" type="button" class="btn btn-primary">Add Book</button>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body mx-5">
                    <div class="col mb-3">
                        ...
                        <input v-model="newBook.title" type="text" class="form-control" id="title" name="title"
                            required />
                    </div>
                    <div class="col mb-3">
                        ...
                        <input v-model="newBook.author" type="text" class="form-control" id="author" name="author"
                            required />
                    </div>
                    <div class="col mb-3">
                        ...
                        <textarea v-model="newBook.description" name="description" id="description" class="form-control"
                    ...
                    <div class="col mb-3">
                        ...
                        <input v-model="newBook.pageNumber" type="number" class="form-control" id="numOfPages"
...
export default {
    ...
    computed: {
        ...
        userBooks() {
            return this.userUploadedBooks.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt));
        }
    },
    methods: {
